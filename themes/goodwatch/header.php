...
<head>
    ...
    <link rel="preload" href="https://goodwatch.cc/wp-content/themes/goodwatch/assets/node_modules/@fortawesome/fontawesome-free/webfonts/fa-regular-400.woff2" as="font" type="font/woff2" crossorigin>
	<? wp_head() ?>
            ...
            <div class="catalog-menu-box">
                ...
                <ul class="catalog-menu pb-0 catalog-main-menu">
		            <? while ( have_rows( 'header_menu', lang() ) ):the_row();
			            ...
			            ?>
                        <li class="dropdown">
                            <a href="<? the_sub_field( 'link' ) ?>" class="<?= $active ?>"><? the_sub_field( 'title' ) ?></a>
                        </li>
		            <? endwhile; ?>
                </ul>
				<? wp_nav_menu( [
													...
													<? foreach ( get_sub_field( 'products' ) as $post ):
                                                        ...
                                                        <div class="product-card">
                                                            <a href="<? the_permalink() ?>" class="product-thumbnail">
                                                                <img width="150" height="150" src="<? the_post_thumbnail_url('thumbnail') ?>" class="attachment-thumbnail size-thumbnail wp-post-image" alt="<? the_title() ?>">
                                                            </a>
